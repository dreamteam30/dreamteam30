...
public class Lab7 {
    ...
    private void runAnalysis(){
        ...
        System.out.println("\n");
        helper.getAverageLikesComment();
        
        System.out.println("\n");
        helper.getPostWithMostLikesComment();
        
        System.out.println("\n");
        helper.getPostWithMostComment();
        
        System.out.println("\n");
        helper.Top5InactiveUsersOnTotalPostsNumber();
        
        System.out.println("\n");
        helper.getFiveMostInactiveUsersOnCommentNumberMethod1();
        
        System.out.println("\n");
        helper.getFiveMostInactiveUsersOnOverall();
        
        System.out.println("\n");
        helper.getFiveMostProactiveUsersOnOverall();
